...
//    COMMAND_HELP_NO_MORE_PAGES("&cNo more pages present.", 1, 2),
    ...
    COMMAND_USER_XP_SUCCESS("&e%amount% &3XP has been added to &e%player%'s &3XP. New XP&8: &e%new%", 1, 2, 3),
    ...
    COMMAND_USER_SOULS_SUCCESS("&3%amount% has been added to the soul count", 1, 2, 3),
    ...
    COMMAND_USER_STATPOINTS_SUCCESS("&3%amount% statpoints have been added to the player", 1, 2, 3),
    COMMAND_USER_LEVEL_SUCCESS("&3%amount% has been added to the player's level", 1, 2, 3),
    COMMAND_USER_LEVEL_NOT_NUMBER("&clevel must be a number!", 1, 2, 3),
    Command_User_Invalid_Setter("&cInvalid setter&8: &e%setter% &cUse one of the following keywords&8: &eadd/decrease/set", 1, 2),
    ...
    ABILITY_HOOK_DESCRIPTION("&3Right-click to get a grappling hook.\nUseful to escape from your enemies.\nLeveling up only\n" +
            ...
            "&3Level 2: &eYou will not take fall damage from hooks.", 1, 2),
    ...
    ABILITY_EXPLOSION_SPELL_DESCRIPTION("&3When you are attacking, and you're holding a\nstaff, have a chance\n(based on your staff material)\n" +
            "to deal &e%amount%% &3more damage to your enemy.", 1, 3),
    ABILITY_HEAL_SPELL_DESCRIPTION("&3For every 10 mana you have,\nregenerate &e%amount%&3 additional health,\nif your health is below 20%.", 1, 3),
    ...
    ABILITY_DISARM_DESCRIPTION("&3Level 1&8: &ePlace your opponents weapon\nin their inventory if\nthey have a free space.\n" +
            ...
            "&3Level 3&8: &eAlso change the hotbar slot they're using.", 1, 2),
    Skill_Mage_Activation_Message("&3&l*WHOOSH!*", 1, 2),
    ABILITY_FIREMAGE_PASSIVE_DESCRIPTION("&3When on fire, regain &e%amount% &3extra\nhealth when healing.\nYou are also immune to fire damage.", 1, 3),
    ABILITY_ABSORB_ENERGY_DESCRIPTION("&3When attacked, your next attack will\nset your targets on fire\nfor up to &e%amount% &3seconds.", 1, 3),
    ABILITY_PHOENIX_ESSENCE_DESCRIPTION("&3Deal &e%amount% &3more damage\nfor every &61 second\n&3your target is on fire for.", 1, 3),
    ABILITY_BLACK_FIRE_DESCRIPTION("&3When targets in a radius\nof &65 blocks &3to you,\nincrease their fire damage by &e%amount%", 1, 3),
    ...
    ABILITY_INFERNO_DESCRIPTION("&3Right click, and hit a target\nwith your staff to activate.\nImmediately deal &e%amount% &3damage,\n" +
            "plus 1 damage per 20 fireticks the target has", 1, 2),
    ...
    ABILITY_NEPTUNE_DESCRIPTION("&3Level 1&8: &eDeal %amount% &emore damage with tridents.\n" +
    ...
    ABILITY_JUGGERNAUT_PASSIVE_DESCRIPTION("&3Reduce entity attacks by &e%amount%", 1, 3),
    ABILITY_HEAVY_STRIKES_DESCRIPTION("&3If you are using an axe to attack,\ndeal &e%amount% &3more damage to your\ntargets armors.", 1, 3),
    ABILITY_STONE_SKIN_DESCRIPTION("&3Level 1&8: &eFall damage is reduced by &6%fall%\n&3Level 2&8: &eFire/lava damage is\nreduced by &6%fire%/%lava%\n" +
            "&3Level 3&8: &eThorns damage is\nis reduced by %thorns%", 1, 3),
    ABILITY_AEGIS_PROTECTION_DESCRIPTION("&eLevel 1&8: &3Every &e%amount%&3 seconds,\nrefresh a shield that negates all\ndamage for the next attack.\n" +
    ...
    ABILITY_THROW_DESCRIPTION("&3Right-click and hit\nyour target to activate.\nCarry your target for 3 seconds,\nmaking you and your target unable\nto attack for the " +
            ...
            "\nWhile you are carrying your target,\nall incoming damage is reduced by 50%", 1, 2),
    ...
    Skill_Juggernaut_Active_Throw_Message_Countdown("&c&lAIM! Throwing opponent in your direction in %countdown%", 1, 2),
    ...
    ABILITY_DEFILE_DESCRIPTION("&3Right-click and attack to tip\nthe balance in your target,\nincreasing its damage taken,\n" +
            "and reducing its damage dealt to\nyou by &6%amount%% &3for &e%time% seconds&3.", 1, 2),
    ...
    ABILITY_METEORITE_DESCRIPTION("&3Fire multiple\nfireballs at your enemy.\nHigher level gives you more fireball\nand explosion power.", 1, 2),
